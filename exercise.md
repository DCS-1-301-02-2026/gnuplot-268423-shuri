...
plot "weather2026.csv" using 1:2 w l title "最高気温" , \
"weather2026.csv" using 1:3 w l title "最高気温(平均)" , \
"weather2026.csv" using 1:4 w l title "最低気温" , \
"weather2026.csv" using 1:5 w l title "最低気温(平年)"
...
plot "bm.txt" using 1:2:xtic(1) with boxes linecolor "blue"
